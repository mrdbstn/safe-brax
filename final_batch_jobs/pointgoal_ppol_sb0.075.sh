...
#SBATCH --job-name=pointgoal_ppol_sb0.075
#SBATCH --output=logs/pointgoal_ppol_sb0.075_%j.txt
...
echo "=================================================="
echo "Training PointGoal PPO-L SB 0.075 (20 seeds)"
echo "Started at $(date)"
echo "=================================================="

# Run training with 20 seeds
python train_from_config.py \
    --config configs/final/pointgoal_ppol_sb0.075.json \
