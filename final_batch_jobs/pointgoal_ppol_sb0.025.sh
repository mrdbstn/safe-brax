...
#SBATCH --job-name=pointgoal_ppol_sb0.025
#SBATCH --output=logs/pointgoal_ppol_sb0.025_%j.txt
...
echo "=================================================="
echo "Training PointGoal PPO-L SB 0.025 (20 seeds)"
echo "Started at $(date)"
echo "=================================================="

# Run training with 20 seeds
python train_from_config.py \
    --config configs/final/pointgoal_ppol_sb0.025.json \
