...
#SBATCH --job-name=ant_velocity_ppol_sb0.2
#SBATCH --output=logs/ant_velocity_ppol_sb0.2_%j.txt
...
echo "=================================================="
echo "Training Ant Velocity PPO-L SB 0.2 (20 seeds)"
echo "Started at $(date)"
echo "=================================================="

# Run training with 20 seeds
python train_from_config.py \
    --config configs/final/ant_velocity_ppol_sb0.2.json \
