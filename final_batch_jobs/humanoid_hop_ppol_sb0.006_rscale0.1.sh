...
#SBATCH --job-name=humanoid_hop_ppol_sb0.006_rscale0.1
#SBATCH --output=logs/humanoid_hop_ppol_sb0.006_rscale0.1_%j.txt
...
echo "=================================================="
echo "Training Humanoid Hop PPO-L SB 0.006 RScale 0.1 (10 seeds)"
echo "Started at $(date)"
echo "=================================================="

# Run training with 10 seeds
python train_from_config.py \
    --config configs/final/humanoid_hop_ppol_sb0.006_rscale0.1.json \
